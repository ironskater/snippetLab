package snippetlab.java.hibernate.one2one_bidirection_delete;
...
public class App
{
		...
		main( String[] args )
	{
		...
		try {
			...
			System.out.println("Deleting tempInstructorDetail2: " + tempInstructorDetail2);
			session.delete(tempInstructorDetail2);
