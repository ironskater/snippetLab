package snippetlab.java.hibernate.basic_update;
...
public class App
{
		...
		main( String[] args )
	{
		...
		try {
			...
			System.out.println("======================= Before update, myStudent: " + myStudent.toString());

			myStudent.setLastName("updateHibernate");

			session.getTransaction().commit();

			System.out.println("Done!!!!");
			System.out.println("======================= After update, myStudent: " + myStudent.toString());
		}
		finally {
			factory.close();
		}
