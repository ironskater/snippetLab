...
public class App
{
		...
		main( String[] args )
	{
		...
		MediaPlayer enhancedAudioPlayer = new EnhancedAudioPlayer();

		enhancedAudioPlayer.play("mp3", "beyond the horizon.mp3");
		enhancedAudioPlayer.play("mp4", "alone.mp4");
		enhancedAudioPlayer.play("vlc", "far far away.vlc");
	}
}
